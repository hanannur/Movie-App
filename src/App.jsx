...
function App() {
    ...
    const[debouncedSearchTerrm , setDebouncedTerm ]=useState('')
    const[trendingSearches , setTrendingSearches]=useState([])   

    useDebounce(()=>
    setDebouncedTerm(searchTerm) , 500 ,[searchTerm] )
    ...
    const fetchMovies = async (query) => {
        ...
        try {
            ...
            ?`${API_BASE_URL}/search/movie?query=${encodeURIComponenet(query)}`
